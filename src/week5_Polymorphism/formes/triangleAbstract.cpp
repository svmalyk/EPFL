...
\*---------------------------------------------------------------------------*/
#include "triangleAbstract.hpp"

// Constructors
    
// Default Constructor
TriangleAbstract::TriangleAbstract() = default;

// Overloaded Constructor
TriangleAbstract::TriangleAbstract(double base_, double height_):
  base(base_),
  height(height_)
{/*
...
// methods
void TriangleAbstract::description() {
    std::cout << "Ceci est un triangle !" << std::endl;
}

double TriangleAbstract::aire() const {
